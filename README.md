# Spotify Link Redirect Chrome Extension
...
## How to Use
1. Download the compressed .zip from the releases section on the right, by clicking on the latest release and then `Source code
(zip)`
